...
| **Regression / corridor model**        |   🧩   | Profitability insights now include baseline and corridor-aware margin-per-m³ regression over distance/season, plus fit-improvement reporting; stronger validation and model-governance work remain pending. |
