...
| **Backhaul / container sharing**                         |   🧩   | Quote backhaul detection and discount guidance are implemented, and Dispatch now surfaces persisted spare-capacity, container-pressure context, and share/reallocation recommendations; broader operational container-sharing and under-/over-utilisation handling still pending. |
