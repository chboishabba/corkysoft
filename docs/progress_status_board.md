...
- Broader backhaul / container-sharing operational visibility: **🟡 in progress** (Dispatch now surfaces persisted spare-capacity signals and container pressure for awarded/planned jobs; deeper sharing and utilisation handling still pending)
...
- Extend dispatch/inventory handling from visibility into active backhaul/container-sharing decisions and under-/over-utilisation response.
