...
def get_worker_time_events(
    review_status: Optional[str] = Query(
        default=None, description="Optional review-status filter"
    ),
...
def get_state_egress_events(
    ...
    event_family: Optional[str] = Query(
        default=None, alias="eventFamily", description="Optional observer event family"
    ),
    job_id: Optional[int] = Query(
        default=None, alias="jobId", description="Optional job identifier filter"
    ),
    start_time: Optional[str] = Query(
        default=None, alias="startTime", description="Earliest event time to return"
    ),
    end_time: Optional[str] = Query(
        default=None, alias="endTime", description="Latest event time to return"
    ),
    cursor: Optional[str] = Query(
        default=None, description="Opaque cursor returned by a previous listing call"
    ),
